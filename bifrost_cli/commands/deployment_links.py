...
def get_deployment_links(
    ...
    if response is not None and response.status_code == 200:
        ...
        print("❌ [bold red]Failed to fetch asset deployment links.[/bold red]")
        return None
...
def deployment_links(
    ...
    res = get_deployment_links(asset_id=asset_id, base_url=base_url)
    if res and len(res["deployment__links"]) > 0:
        print("✅ [bold green]Successfully fetched asset deployment links[/bold green]")
