...
def main():
    ...
    parser.add_argument("-rm", "--delete", metavar="FORM_ID", help="Deletes the specified form")
    parser.add_argument("-cd", "--create-deploy", metavar="FILEPATH", help="Creates and deploys a new form")
    parser.add_argument("-u", "--update", nargs=2, metavar=("FORM_ID", "FILEPATH"), help="Updates a Kobo form")
    parser.add_argument("-d", "--deploy", metavar="FORM_ID", help="Deploys a form")
    parser.add_argument("-rd", "--redeploy", metavar="FORM_ID", help="Redeploys a form")
    parser.add_argument("-urd", "--update-redeploy", nargs=2, metavar=("FORM_ID", "FILEPATH"), help="Updates and redeploys a form")
    parser.add_argument("-swa", "--submit-without-auth", metavar="FORM_ID", help="Enables 'Submit data without auth' feature")
    parser.add_argument("-pc", "--permission-clone", nargs=2, metavar=("TARGET_FORM_ID", "SOURCE_FORM_ID"), help="Clones permissions from another Kobo form")
